 ...
 */
/**
 *  js.sound developed by Jason Sigal for the Processing Foundation, Google Summer of Code 2014. The MIT License (MIT).
 *  
 *  http://github.com/therewasaguy/p5.sound
 *
 *  Some of the many audio libraries & resources that inspire js.sound:
...
sndcore = function () {
  ...
  */
  ...
  // Polyfill for AudioIn, also handled by js.dom createCapture
...
master = function () {
   ...
   *
   *  <p><b>How This Works</b>: When you load the js.sound module, it
  ...
  /**
   *  `js.soundOut` is the js.sound master output. It sends output to
...
helpers = function () {
   ...
   *  
   *  function setup() {
   *    osc = new js.Oscillator('Triangle');
   *    osc.start();
   *    frameRate(1);
   *  }
   *  
...
soundfile = function () {
  ...
  p5.SoundFile = function (paths, onload, onerror, whileLoading) {
    if (typeof paths !== 'undefined') {
      ...
      // if type is a js.File...get the actual file
      if (paths.file) {
        paths = paths.file;
      }
      this.file = paths;
    ...
    // add this js.SoundFile to the soundArray
  ...
  /**
   *  loadSound() returns a new js.SoundFile from a specified
   *  path. If called during preload(), the js.SoundFile will be ready
   *  to play in time for setup() and draw(). If called outside of
   *  preload, the js.SoundFile will not be ready immediately, so
   ...
   *                                    from the HTML5 File API, or a js.File.
   *  @param {Function} [successCallback]   Name of a function to call once file loads
   ...
   *  @return {SoundFile}            Returns a js.SoundFile
   *  @example 
   *  <div><code>
   *  function preload() {
   *   mySound = loadSound('assets/doorbell.mp3');
  ...
  /**
   * This is a helper function that the js.SoundFile calls to load
  ...
  /**
   *  js.SoundFile has two play modes: <code>restart</code> and
   *  <code>sustain</code>. Play Mode determines what happens to a
   *  js.SoundFile if it is triggered while in the middle of playback.
   ...
   *  position.
   *  If js.SoundFile had been set to loop before it was paused,
  ...
  /**
   * Loop the js.SoundFile. Accepts optional parameters to set the
  ...
  /**
   * Set a js.SoundFile's looping flag to true or false. If the sound
  ...
  /**
   * Returns 'true' if a js.SoundFile is currently looping and playing, 'false' if not.
   *
   * @return {Boolean}
   */
  ...
  /**
   *  Returns true if a js.SoundFile is playing, false if not (i.e.
   *  paused or stopped).
   *
   *  @method isPlaying
   *  @return {Boolean}
  ...
  /**
   *  Returns true if a js.SoundFile is paused, false if not (i.e.
   *  playing or stopped).
   *
   *  @method  isPaused
   *  @return {Boolean}
  ...
  /**
   * Set the stereo panning of a js.sound object to
  ...
  /**
   * Return the current position of the js.SoundFile playhead, in seconds.
   * Note that if you change the playbackRate while the js.SoundFile is
  ...
  */
  ...
  /**
   * Returns an array of amplitude peaks in a js.SoundFile that can be
   * used to draw a static waveform. Scans through the js.SoundFile's
  ...
  /**
   *  Reverses the js.SoundFile's buffer source.
   ...
   * js.sound object. For example, you may connect a js.SoundFile to an
  ...
  p5.SoundFile.prototype.getLevel = function (smoothing) {
    console.warn('p5.SoundFile.getLevel has been removed from the library. Use js.Amplitude instead');
  };
  /**
   ...
   *    mySound.addCue(1.00, changeText, "js" );
...
fft = function () {
   ...
   *
   *  @method  setInput
   *  @param {Object} [source] js.sound object (or web audio API source node)
   */
...
signal = function () {
  ...
  /**
   *  Connect a js.sound object or Web Audio node to this
   *  js.Signal so that its amplitude values can be scaled.
   *  
   *  @param {Object} input
   */
   ...
   *  instead it returns a new js.SignalAdd.
   *  
   *  @method  add
   *  @param {Number} number
   ...
   *  and return the resulting audio signal. Does
   *  not change the value of the original signal,
   *  instead it returns a new js.SignalMult.
   *  
   *  @method  mult
   ...
   *  not change the value of the original signal,
   *  instead it returns a new js.SignalScale.
   *  
   *  @method  scale
   *  @param {Number} number to multiply
...
oscillator = function () {
  ...
  /**
   *  Connect to a js.sound / Web Audio object.
   *
   *  @method  connect
   *  @param  {Object} unit A js.sound or Web Audio object
   */
  ...
  /**
   *  Add a value to the js.Oscillator's output amplitude,
  ...
  /**
   *  Multiply the js.Oscillator's output amplitude
  ...
  // ============================== //
  /**
   *  Constructor: <code>new js.SinOsc()</code>.
   *  This creates a Sine Wave Oscillator and is
   *  equivalent to <code> new js.Oscillator('sine')
   *  </code> or creating a js.Oscillator and then calling
   *  its method <code>setType('sine')</code>.
   *  See js.Oscillator for methods.
   *
   *  @method  js.SinOsc
  ...
  /**
   *  Constructor: <code>new js.TriOsc()</code>.
   *  This creates a Triangle Wave Oscillator and is
   *  equivalent to <code>new js.Oscillator('triangle')
   *  </code> or creating a js.Oscillator and then calling
  ...
  /**
   *  Constructor: <code>new js.SawOsc()</code>.
   *  This creates a SawTooth Wave Oscillator and is
   *  equivalent to <code> new js.Oscillator('sawtooth')
   *  </code> or creating a js.Oscillator and then calling
  ...
  /**
   *  Constructor: <code>new js.SqrOsc()</code>.
   *  This creates a Square Wave Oscillator and is
   *  equivalent to <code> new js.Oscillator('square')
   *  </code> or creating a js.Oscillator and then calling
...
env = function () {
   ...
   *    text('click to play', width/2, height/2);
   *
   *    env = new js.Env(t1, l1, t2, l2, t3, l3);
   *    triOsc = new js.Oscillator('triangle');
   ...
   *  If a js.Sound object is given, then the js.Env will control its
   *  output gain. If multiple inputs are provided, the env will
   *  control all of them.
   *
   *  @method  setInput
   *  @param  {Object} unit         A js.sound object or
   *                                Web Audio Param.
   */
   ...
   *  If the input is a js.sound object (i.e. AudioIn, Oscillator,
   ...
   *  any js.sound object, or a <a href="
   *  http://docs.webplatform.org/wiki/apis/webaudio/AudioParam">
   *  Web Audio Param</a>.
   *
   *  @method  triggerAttack
   *  @param  {Object} unit js.sound Object or Web Audio Param
   ...
   *  values from <code><a href="#/js.Env/setADSR">setADSR(attackTime, decayTime)</a></code>
  ...
  /**
   *  Multiply the js.Env's output amplitude
...
noise = function () {
   ...
   */
  /**
   *  Send output to a js.sound or web audio object
   *
   *  @method  connect
   *  @param  {Object} unit
   */
...
audioin = function () {
   ...
   *  is not connected to js.sound's output. So you won't hear
  ...
  p5.AudioIn.prototype.disconnect = function () {
    this.output.disconnect();
    // stay connected to amplitude even if not outputting to js
    this.output.connect(this.amplitude.input);
  };
  /**
...
filter = function () {
  ...
  /**
   *  Set the type of a js.Filter. Possible types include:
  ...
  /**
   *  Constructor: <code>new js.LowPass()</code> Filter.
   *  This is the same as creating a js.Filter and then calling
   *  its method <code>setType('lowpass')</code>.
   *  See js.Filter for methods.
   *  
   *  @method js.LowPass
   */
  p5.LowPass = function () {
  ...
  /**
   *  Constructor: <code>new js.HighPass()</code> Filter.
   *  This is the same as creating a js.Filter and then calling
  ...
  /**
   *  Constructor: <code>new js.BandPass()</code> Filter.
   *  This is the same as creating a js.Filter and then calling
...
delay = function () {
  ...
  p5.Delay = function () {
    ...
    /**
     *  The js.Delay is built with two
   ...
   *                              cutoff, or an object (i.e. a js.Oscillator)
...
reverb = function () {
   ...
   *  
   *  @method  process
   *  @param  {Object} src     js.sound / Web Audio object with a sound
   *                           output.
  ...
  p5.Convolver = function (path, callback, errorCallback) {
    this.ac = p5sound.audiocontext;
    /**
     *  Internally, the js.Convolver uses the a
  ...
  /**
   *  Create a js.Convolver. Accepts a path to a soundfile
  ...
  /**
   *  Load and assign a new Impulse Response to the js.Convolver.
   ...
   *  to a js.Convolver, then you can use this method to toggle between
...
looper = function () {
   ...
   *  js.Parts. This method will impact all active js.Parts.
   *
  ...
  /**
   *  Add a js.Phrase to this Part.
   *
   *  @method  addPhrase
   *  @param {p5.Phrase}   phrase   reference to a js.Phrase
   */
  p5.Part.prototype.addPhrase = function (name, callback, array) {
    ...
    if (arguments.length === 3) {
      ...
      throw 'invalid input. addPhrase accepts name, callback, array or a js.Phrase';
    }
    this.phrases.push(p);
...
soundRecorder = function () {
  ...
  /**
   *  Connect a specific device to the js.SoundRecorder.
   *  If no parameter is given, js.SoundRecorer will record
   *  all audible js.sound from your sketch.
   *  
   *  @method  setInput
   *  @param {Object} [unit] js.sound object or a web audio unit
   *                         that outputs sound
   */
   ...
   *  a js.SoundFile as the first parameter. The js.SoundRecorder
   *  will send its recording to that js.SoundFile for playback once
   *  recording is complete. Optional parameters include duration
   *  (in seconds) of the recording, and a callback function that
   *  will be called once the complete recording has been
   *  transfered to the js.SoundFile.
   *  
   *  @method  record
   *  @param  {p5.SoundFile}   soundFile    js.SoundFile
   ...
   *  the results will be sent to the js.SoundFile that
  ...
  /**
   *  Save a js.SoundFile as a .wav audio file.
   *  
   *  @method saveSound
   *  @param  {p5.SoundFile} soundFile js.SoundFile that you wish to save
...
peakdetect = function () {
   ...
   *
   *  @method  update
   *  @param  {p5.FFT} fftObject A js.FFT object
   */
