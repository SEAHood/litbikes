...
// =============================================================================
   ...
   * a js.Element. If a class or tag name is given with more than 1 element,
   ...
   * @param  {String} [container] id, js.Element, or HTML element to search within
   * @return {Object/p5.Element|Null} js.Element containing node found
   * @example
   ...
   * to specify a class and no prefix for a tag) and returns them as js.Elements
   * in an array.
   * The DOM node itself can be accessed with .elt.
   ...
   * @param  {String} [container] id, js.Element, or HTML element to search within
   * @return {Array} Array of js.Elements containing nodes found
   * @example
  ...
  /**
   * Removes all elements created by js, except any canvas / graphics
   ...
   * @return {Object/p5.Element} pointer to js.Element holding created node
   * @example
   * <div class='norender'><code>
   * var myDiv;
   * function setup() {
  ...
  p5.prototype.createCheckbox = function() {
    ...
    //checkbox must be wrapped in js.Element before label so that label appears after
   ...
   * @return {Object/p5.Element} pointer to js.Element holding created DOM element
   */
   ...
   * @return {Object/p5.Element} pointer to video js.Element
   */
   ...
   *                             up to its end without having to stop for
   *                             further buffering of content
   * @return {Object/p5.Element} pointer to audio js.Element
   */
   ...
   *                                    stream has loaded
   * @return {Object/p5.Element} capture video js.Element
   * @example
   * <div class='norender'><code>
   * var capture;
   *
   ...
   * @example
   * <div class='norender'><code>
   * var h2 = createElement('h2','im an h2 js.element!');
   * </code></div>
   */
...
// =============================================================================
   ...
   * Accepts either a string ID, DOM node, or js.Element.
   * If no argument is specified, an array of children DOM nodes is returned.
   *
   * @method child
   * @param  {String|Object|p5.Element} [child] the ID, DOM node, or js.Element
   ...
   * div0.child(div1); // use js.Element
   * </code></div>
   * <div class='norender'><code>
   * var div0 = createDiv('this is the parent');
   * var div1 = createDiv('this is the child');
  ...
  /**
   * Centers a js Element either vertically, horizontally,
   * or both, relative to its parent or according to
   * the body if the Element has no parent. If no argument is passed
   * the Element is aligned both vertically and horizontally.
   *
   * @param  {String} align       passing 'vertical', 'horizontal' aligns element accordingly
   * @return {Object/p5.Element} pointer to js.Element
   * @example
   * <div><code>
   * function setup() {
  ...
  /* Helper method called by js.Element.style() */
   ...
   * @return {String|Object/p5.Element} value of element if no value is specified or js.Element
   * @example
   * <div class='norender'><code>
   * // gets the value
   * var inp;
  ...
  p5.Element.prototype.size = function(w, h) {
    if (arguments.length === 0){
      ...
      if (aW !== AUTO || aH !== AUTO) {
        ...
        if (this._pInst) { // main canvas associated with js instance
...
// =============================================================================
   ...
   * @return {Number|p5.MediaElement} current volume or js.MediaElement
   * @method volume
   */
   ...
   * @return {Number|Object/p5.MediaElement} current playback speed or js.MediaElement
   */
  ...
  /*** CONNECT TO WEB AUDIO API / js.sound.js ***/

  /**
   *  Send the audio output of this element to a specified audioNode or
   *  js.sound object. If no element is provided, connects to js's master
   *  output. That connection is established when this method is first called.
   *  All connections are removed by the .disconnect() method.
   *
   *  This method is meant to be used with the js.sound.js addon library.
   *
   *  @method  connect
   *  @param  {AudioNode|js.sound object} audioNode AudioNode from the Web Audio API,
   *  or an object from the js.sound library
   */
  p5.MediaElement.prototype.connect = function(obj) {
    var audioContext, masterOutput;

    // if js.sound exists, same audio context
    if (typeof p5.prototype.getAudioContext === 'function') {
      ...
      try {
        ...
        throw 'connect() is meant to be used with Web Audio API or js.sound.js'
      }
    }
    ...
    // otherwise connect to master output of js.sound / AudioContext
    else {
      this.audioSourceNode.connect(masterOutput);
    }
